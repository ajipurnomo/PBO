...
KELAS   : IF 2
NIM     : 10117073
Deskripsi : membuat program untuk mengetahui kepribadian orang dengan cara user
            menginputkan warna pilihannya.
 */
package if2_10117073_latihan29_warnakepribadian;

import java.util.Scanner;

public class IF2_10117073_LATIHAN29_WarnaKepribadian {
    //    kode text color
